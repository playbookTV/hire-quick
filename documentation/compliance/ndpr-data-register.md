...
| **ID document** | `UsherVerification.idDocumentUrl` | KYC / identity verification | Legal obligation | KYC trail 7 years | DSAR erase clears ref; object deleted by storage hook |
| **Selfie (biometric)** | `UsherVerification.selfieUrl` | KYC liveness | Legal obligation | KYC trail 7 years | DSAR erase clears ref; object deleted by storage hook |
...
| Authored messages | `Message.content` | In-app chat | Contract | Life of account | DSAR erase → redacted |
...
- Confirm retention windows (TRD §23 item 9): currently 30 d OTP, 180 d device tokens, 7 y financial/KYC.
